...
class RobustPrompt_I(torch.nn.Module):
    def __init__(self, in_channels: int, muti_defense_pt_dict, p_plus, use_attention, num_heads, kl_global, cosine_constraint, pt_threshold, temperature, weight_mse, weight_kl, weight_constraint, filter_module=None):
        ...
        print('filter_module : ', self.filter_module.__class__.__name__)
